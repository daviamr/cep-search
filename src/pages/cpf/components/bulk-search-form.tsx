...
import { bulkSearchCPF } from "@/lib/api/cpf"
...
export function BulkSearchForm({ onUploadSuccess }: BulkSearchFormProps) {
  ...
  async function onSubmit({ file }: BulkSearchValues) {
    ...
    const success = await bulkSearchCPF(file)
  ...
  return (
    <Dialog open={open} onOpenChange={handleOpenChange}>
      ...
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          <DialogTitle>Nova consulta de CPFs</DialogTitle>
          <DialogDescription>
            Envie um arquivo .csv ou .xlsx com a lista de CPFs para consulta.
          </DialogDescription>
        </DialogHeader>
